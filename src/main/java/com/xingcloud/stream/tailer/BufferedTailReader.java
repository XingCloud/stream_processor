/*
 * @(#)BufferedReader.java	1.38 10/03/23
 *
...
public class BufferedTailReader extends Reader {
     ...
     */
    public BufferedTailReader(Reader in, int sz) {
        super(in);
        if (sz <= 0)
     ...
     * @param in A Reader
     */
    public BufferedTailReader(Reader in) {
     ...
     *
     * @throws java.io.IOException If the stream has never been marked,
